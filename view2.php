...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="C:\Users\black\OneDrive\Desktop\Project SK\icons8-warehouse-100.png"
      type="image/x-icon"
    />
  ...
  <body bgcolor="#B4B4B8" style="color: rgb(0, 0, 0)">
        <?php 
          if(isset($_POST["addCart"])){
            ...
            $sql="select * from sec2 where pid='{$_GET["id"]}'";
            $res=$con->query($sql);
            if($res->num_rows>0) 
            {
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="product-image">
                                    <div class="product-image-main">
                                        <img src="RES/Src/'. $row['PIC'] .'" alt="" id="product-main-image" />
                                    </div>
                            ...
                            <div class="product">
                                ...
                                <div class="product-btn-group">
                                    ...
                                    <!-- <div class="button add-cart"><i><img src="cart1.png" alt="" /></i> Add to Cart</div> -->
