      ...
      <h2 id="head">Selvi Electricals & Hardware Store</h2>      
        <header>
          <ul style="background-color: #607274" id="navbar">
            ...
            <li>
              <a href="product1.php" style="text-decoration: none">Products</a>
            </li>
            <li>
        ...
        <p style="text-align:right;font-family: Microsoft JhengHei;"><?php echo $_SESSION["email"]; ?><a href="logout.php" style="color:black;"> <b>logout</b></a></p>
              ...
              if($res->num_rows>0)
              {
                  while($row=$res->fetch_assoc())
                  {
                          echo '
                                      ...
                                      <div class="card">
                                          <img src="RES/Src/'. $row['PIC'] .'" alt="" width="250px" height="255px"/>
                                          <p><b>'. $row['BNAME'] .'</b></p>
              ...
              if($res->num_rows>0)
              {
                  while($row=$res->fetch_assoc())
                  {
                          echo '
                                      ...
                                      <div class="card">
                                          <img src="RES/Src/'. $row['PIC'] .'" alt="" width="250px" height="210px"/>
                                          <p><b>'. $row['BNAME'] .'</b></p>
